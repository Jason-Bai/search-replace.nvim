...
describe("Output Parser", function()
  it("should parse real rg JSON match output", function()
    ...
    local json_line =
      [[{"type":"match","data":{"path":{"text":"lua/search-replace/init.lua"},"lines":{"text":"local M = {}\n"},"line_number":8,"absolute_offset":200,"submatches":[{"match":{"text":"M"},"start":6,"end":7}]}}]]
  ...
  it("should ignore begin/end/summary types", function()
    ...
    local end_line =
      [[{"type":"end","data":{"path":{"text":"lua/search-replace/init.lua"},"binary_offset":null,"stats":{"elapsed":{"secs":0,"nanos":123456},"searches":1,"searches_with_match":1,"bytes_searched":100,"bytes_printed":200,"matched_lines":1,"matches":1}}}]]
